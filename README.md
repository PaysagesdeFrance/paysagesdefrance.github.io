...
<body>
	...
	<form id="searchForm" action="self" method="get">
		<div class="combobox">
	...
	<hr> <b>Historique :</b>
	<ul style="list-style-type:square">
 		<li>version 1.04q du 17/03/2024 : Implantation Content Security Policy header, Subresource integrity, X-Content-Type-Options header, X-Frame-Options header, referrer-policy header</li>
