...
<head>
	...
	<meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'self'; img-src *; script-src 'self' https://code.jquery.com; frame-ancestors 'self';">
	...
	<script defer src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js" integrity="sha256-KdYARiowaU79FbmEi0ykLReM0GcAknXDWjBYASERQwQ=" crossorigin="anonymous"></script>
	<style>
	body {
...
<body>
	...
	<ul style="list-style-type:square">
		...
		<li>(5) informations mises à jour manuellement – valable au 1er janvier 2024 – source : <a href="https://www.banatic.interieur.gouv.fr/" target="_blank">https://www.banatic.interieur.gouv.fr/</a></li>
	...
	<hr> <b>Historique :</b>
	<ul style="list-style-type:square">
 		<li>version 1.06b du 22/03/2024 : Mise à jour du CSP</li>
