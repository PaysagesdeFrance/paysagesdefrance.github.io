...
<head>
	...
	<meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' https://code.jquery.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; connect-src 'self' https://geo.api.gouv.fr https://api-lannuaire.service-public.fr; frame-ancestors 'none';">
...
function debounce(func, delay) {
	...
	<hr> <b>Historique :</b>
	<ul style="list-style-type:square">
		<li>version 1.12d du 17/10/2024 : Amélioration de la sécurité</li>
